...
public class RedisServiceImpl implements RedisService {
    ...
    public Double zScore(String key, Object value) {
        return Optional.ofNullable(redisTemplate.opsForZSet().score(key, value)).orElse(0D);
    }
    ...
    @Override
    public Long hyperGet(String... keys) {
    ...
    @Override
    public List<Point> geoGetPointList(String key, Object... places) {
        return redisTemplate.opsForGeo().position(key, places);
    }

    @Override
    public Distance geoCalculationDistance(String key, String placeOne, String placeTwo) {
        return redisTemplate.opsForGeo().distance(key, placeOne, placeTwo);
    }
    ...
    @Override
    public List<String> geoGetHash(String key, String... places) {
        return redisTemplate.opsForGeo().hash(key, places);
    }
}
